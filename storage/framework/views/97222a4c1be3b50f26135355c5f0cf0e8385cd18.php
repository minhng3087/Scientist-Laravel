							...
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="banners-box">
									<div class="title-box">
										...
										<p><?php echo e(Session::get('lang') == 'vn' ? $about->mota : $about->mota_eg); ?><a href="#" title="<?php echo e(__('Xem thêm')); ?>"><?php echo e(__('Xem thêm')); ?> >></a> </p>
									</div>
												...
												<div class="service-box">
													<div class="service-image">
														...
														<h4 class="service-name">
															<a href="<?php echo e(route('getServiceDetail', ['alias'=>$services[0]['alias']])); ?>" title="service"><?php echo e(Session::get('lang') == 'vn' ? $services[0]['name'] : $services[0]['name_eg']); ?></a>
														</h4>
													</div>
													<div class="service-content">
														...
														<div class="service-excerpt">
															<p><?php echo e(Session::get('lang') == 'vn' ? $services[0]['mota'] : $services[0]['mota_eg']); ?></p>
														</div>
													...
													<li>
														<div class="service-box">
															<div class="service-image">
																...
																<h4 class="service-name">
																	<a href="<?php echo e(route('getServiceDetail', ['alias'=>$services[$i]['alias']])); ?>" title="service"><?php echo e(Session::get('lang') == 'vn' ? $services[$i]['name'] : $services[$i]['name_eg']); ?></a>
																</h4>
															</div>
															<div class="service-content">
																<h4 class="service-name">
																...
																<div class="service-excerpt">
																	<p><?php echo e(Session::get('lang') == 'vn' ? $services[$i]['mota'] : $services[$i]['mota_eg']); ?></p>
																</div>
																<div class="service-button">
